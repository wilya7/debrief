...
| **VETO-07** | Paper caption as body content (journal club only) | For journal-club archetypes: check if a figure caption from an imported paper is rendered as plain body text rather than as a properly styled caption element with attribution. |
